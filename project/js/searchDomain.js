        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $("span.see_whois").click(function(){
                    ...
                    window.open("/getwhoisbyhistoryid.php?domainName=" + domainName +"&domainId="+domainId+"&indexKey="+indexKey+ "&whoisHistoryId=" + historyId,'_self', '');
                });
                ...
                $("span.contrasBtn").click(
                    function() {
                        ...
                        window.open("/diffHistory.php?olderId=" + olderId+ "&newerId=" + newerId + "&domainName=" + domainName,'_self', '');
                    }
                )
            },
            error: function(XMLHttpRequest, textStatus, errorThrown) {
...
$(function() {
    ...
    document.title = "域名"+domainName +"Whois查询,域名"+domainName+"注册信息查询,域名"+domainName+"网站信息查询  ";
    ...
    $("a[name=\"counter\"]").click(function(){
        ...
        $(this).attr("href","/counterCheckDomain.php?key="+cvalue);
    });
